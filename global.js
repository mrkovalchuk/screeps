...
module.exports.REGULAR_CREEPS = {REGULAR_BUILDER_BODY, REGULAR_HARVESTER_BODY, REGULAR_UPGRADER_BODY,
    REGULAR_TRANSPORT_BODY};
module.exports.START_CREEPS = {START_HARVESTER_BODY};
